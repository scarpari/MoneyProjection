...
class estagio:
    def __init__(self, nome, montante0_livre, montante0_investido, montante0_sem_ter_investido,
    ...
    def montante_livre (self):
        ...
        mes = self.mes()
        for element in mes:
            montante_livre += sal * (1 - invest) - gastos
    ...
    def montante_sem_ter_investido(self):
        ...
        mes = self.mes()
        for element in mes:
            montante_SemTerInvestido += sal - gastos
    ...
    def write(self):
        ...
        f.write("-> " + nome + ": \n"
                ...
                "  Rendimento Mensal = {}%".format(sal, gastos, invest * 100, -100 + 100 * earnings))
        for i in mes:
